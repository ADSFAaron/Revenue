#!/usr/bin/env python3
"""Frames raw device captures into Google Play phone screenshots.
...
is what the listing wanted anyway.
    ...
    python3 tool/play_screenshots.py <capture-dir> <out-dir>

Captures are matched to headlines by filename order (01-*.png, 02-*.png, ...).
"""
...
PANELS_EN = [
    ...
    ("Keeps trading when\nthe Wi-Fi doesn't",
     "Orders wait on the phone and send themselves", False),
...
def shadow(canvas, box, radius, dark):
    ...
    canvas.paste(tint, (x - pad, y - pad + 14), layer)
